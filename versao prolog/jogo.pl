...
linhaTabuleiro([H|T],Index,4,Resposta):-Index == 19,write("      "),IndexP is Index + 1 ,linhaTabuleiro(T,IndexP,4,"").
...
linhaTabuleiro(_,Index,5,Resposta):-Index == 19,write("      "),IndexP is Index + 1 ,linhaTabuleiro(_,IndexP,5,"").
